      ...
      >
        ...
        <div class="flex items-center md:order-2 gap-2">
          ...
          >
            ...
            <svg
              class="w-8 h-8 p-1 text-gray-400"
              fill="currentColor"
              viewBox="0 0 20 20"
              xmlns="http://www.w3.org/2000/svg"
            >
        ...
        <div
          class="justify-between items-center w-full md:flex md:w-auto md:order-1 hidden"
          id="mobile-menu-2"
          ref="mainMenu"
          aria-hidden
        >
